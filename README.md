...
> [!IMPORTANT]
> Betelgeuse's companion star, Betelgeuse B (also known as Siwarha) was offically declared on [July 24, 2025](https://iopscience.iop.org/article/10.3847/2041-8213/adeaaf) and as of yet, has no proper motion and is not included in `stars_with_data.csv`
